...
namespace linqdb
{
    ...
    partial void DeleteTitle(Title instance);
		...
		public BooksDataContext() : 
				base(global::linqdb.Properties.Settings.Default.BooksConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnCopyrightChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BookTitle", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
